...
function calculate() {
  ...
  // Updated starting coordinates: N = 500000, E = 100000
  ...
  lines.forEach((line, idx) => {
    ...
    if (line.type === 'Straight') {
      ...
      // Print the straight segment line, rounding End_Easting/End_Northing to 3 decimals
      report.push(
      ...
      // Print the curve line, rounding End_Northing/End_Easting to 3 decimals
      report.push(
...
// On page load, pre-populate the table with example legs:
window.onload = () => {
  document.getElementById('addLineBtn').addEventListener('click', () => addLine());
  document.getElementById('calcBtn').addEventListener('click', calculate);

  // Example pre‐populated legs:
